...
<body>
  ...
  <header id="header">
    <div class="d-flex flex-column">
      ...
      <div class="profile">
      <a href="{{route('espace.nouveau')}}"><img src="assets/img/profile.png" alt="" class="img-fluid rounded-circle"></a>
  ...
  <p>
      ...
      <nav class="nav-menu">
        <ul>
          ...
          <li><a href="{{route('reimprimer')}}"><i class=" bx bx-user"></i>Réimprimer</a></li>
...
<div class="content full-page dashboard m-5  border container ">
                           @yield('content')        
                       </div>
 ...
 <footer id="footer">
    <div class="container">
      ...
      <div class="credits">
        ...
        Simplon Burkina@2020 <a href="https://bootstrapmade.com/">Groupe 8</a>
      </div>
    </div>
  </footer><!-- End  Footer -->
  <link href="assets/vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet">
